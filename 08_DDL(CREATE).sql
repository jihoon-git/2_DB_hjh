...
-- DML(Data Menipulation Language) : 데이터 조작 언어
...
--ORA-00001: 무결성 제약 조건(KH_HJH.USER_ID_U)에 위배됩니다
...
-- * 복합키는 지정된 모든 컬럼의 값이 같을 때 제약조건에 위배된다! *
...
--ORA-00001: 무결성 제약 조건(KH_HJH.USER_ID_NAME_U)에 위배됩니다
...
--> 기본키 중복으로 오류
-- ORA-00001: 무결성 제약 조건(KH_HJH.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'user03', 'pass03', '유관순', '여', '010-9999-3131', 'yoo123@kh.or.kr');
--> 기본키가 NULL 이므로 오류
--ORA-01400: NULL을 ("KH_HJH"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
--ORA-00001: 무결성 제약 조건(KH_HJH.PK_USERNO_USERID)에 위배됩니다
...
--ORA-01400: NULL을 ("KH_HJH"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-02291: 무결성 제약조건(KH_HJH.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
-- ORA-02292: 무결성 제약조건(KH_HJH.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
-- ORA-02290: 체크 제약조건(KH_HJH.GENDER_CHECK)이 위배되었습니다
...
VALUES (1, 'user01', 'pass01', '990101-2234567', '여', '010-1234-5678', '서울시 중구 을지로동', 'N');
INSERT INTO USER_TEST
VALUES (2, 'user02', 'pass01', '980101-1234567', '남', '010-2234-5678', '서울시 중구 을지로동', 'N');
INSERT INTO USER_TEST
VALUES (3, 'user03', 'pass01', '970101-2234567', '여', '010-3234-5678', '서울시 중구 을지로동', 'N');
INSERT INTO USER_TEST
VALUES (4, 'user04', 'pass01', '960101-1234567', '남', '010-4234-5678', '서울시 중구 을지로동', 'N');
INSERT INTO USER_TEST
VALUES (5, 'user05', 'pass01', '950101-2234567', '여', '010-5234-5678', '서울시 중구 을지로동', 'N');
